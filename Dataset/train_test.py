...
def train_test(train_size, device='valve', id=0):
  ...
  Train = torch.utils.data.DataLoader(train_dataset, batch_size=2, shuffle=True, num_workers=4, drop_last=True)
  Test = torch.utils.data.DataLoader(test_dataset, batch_size=3, shuffle=True,num_workers=4)
  return Train, Test
